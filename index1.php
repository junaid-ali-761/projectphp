...
<html lang="en">
  <head>
    ...
    <title>Admin Dashboard Mico Hispital</title>
      ...
      <nav class="sidebar-nav">
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <li>
                <a href="ADD.php" class="active"> Add Doctors </a>
              </li>
              <li>
                <a href="usersdata.php" class="active"> Users DATA </a>
              </li>
              <li>
                <a href="contactdata.php" class="active">Contact US USERS DATA </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Potential growth</h6>
            ...
            <div class="col-lg-5">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap align-items-center justify-content-between">
                  <div class="left">
                    <h6 class="text-medium mb-30">Revenue</h6>
                  </div>
                  <div class="right">
                    <div class="select-style-1">
                      <div class="select-position select-sm">
            ...
            <div class="col-lg-5">
              <div class="card-style mb-30">
                <div class="title d-flex justify-content-between align-items-center">
                  <div class="left">
                    <h6 class="text-medium mb-30"> by State</h6>
                  </div>
                </div>
                <!-- End Title -->
            ...
            <div class="col-lg-7">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap justify-content-between align-items-center">
                  <div class="left">
                    <h6 class="text-medium mb-30">Top </h6>
                  </div>
                  <div class="right">
                    <div class="select-style-1">
                      <div class="select-position select-sm">
